  ...
  return (
    <div className="flex p-4 justify-between w-full   border-b border-gray-500">
      ...
      <div className="flex space-x-4 hidden  sm:flex">
        <Link to="/leaderboard">
          <Button variant="outline" className="w-full font-raleway" type="button">
            LEADERBOARD
